...
class SideMenuFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            // dTODO: initialize the SideMenuFragment variables
     ...
     */
    fun goToNextScreen() {
        // dTODO: Navigate to the AccompanimentMenuFragment
     ...
     */
    fun cancelOrder() {
        // dTODO: Reset order in view model
        sharedViewModel.resetOrder()
        // dTODO: Navigate back to the [StartFragment] to start over
